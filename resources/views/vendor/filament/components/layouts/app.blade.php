...
<x-filament::layouts.base :title="$title">
    <div class="flex w-full min-h-screen overflow-x-hidden filament-app-layout">
        ...
        @if (config('filament.layout.sidebar.is_collapsible_on_desktop'))
            ...
            @else
                <div
                    class="flex flex-col flex-1 w-screen space-y-6 lg:pl-[var(--sidebar-width)] rtl:lg:pl-0 rtl:lg:pr-[var(--sidebar-width)] filament-main">
        @endif
        <header @class([
            'h-[4rem] shrink-0 w-full border-b flex items-center filament-main-topbar bg-white',
