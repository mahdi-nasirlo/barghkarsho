<aside x-data="{}"
    ...
    <header @class([
        ...
        <a href="{{ config('filament.home_url') }}" class="block w-full"
            @if (config('filament.layout.sidebar.is_collapsible_on_desktop')) x-show="$store.sidebar.isOpen"
        ...
        @if (config('filament.layout.sidebar.is_collapsible_on_desktop'))
            <a class="block w-full text-center" href="{{ config('filament.home_url') }}" x-show="! $store.sidebar.isOpen"
