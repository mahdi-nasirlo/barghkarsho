   <div class="tab-pane fade bg-white show active shadow rounded p-4" id="dash" role="tabpanel"
       ...
       <h6 class="text-muted">سلام <span class="text-dark">Jafar_abbasi</span> (نیستید <span
               class="text-dark">Jafar_abbasi</span>? <a href="javascript:void(0)" class="text-danger">خروج</a>)</h6>
